              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>CoverSpecificationId</th>
                        <th>CoverSpecificationName</th>
                        <th>CoverDescription</th>
                        <th>DeleteAction</th>
                        <th>EditAction</th>
                      </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${sessionScope.List}" var="CoverSpecification">
                      <tr>
                        <td>${CoverSpecification.coverSpecificationId}</td>
                        <td>${CoverSpecification.coverSpecificationName}</td>
                        <td>${CoverSpecification.coverDescription}</td>
                        <td><a href="deleteCoverSpecification.do?coverSpecificationId=${CoverSpecification.coverSpecificationId}">Delete</a></td>
                        <td><a href="editCoverSpecification.do?coverSpecificationId=${CoverSpecification.coverSpecificationId}">Edit</a></td>
                        </tr>
                        </c:forEach>
                     </tbody>
                  </table>
