              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <c:forEach items="${sessionScope.List}" var="subcategory">
                      <tr>
                        <td>${subcategory.subCategoryId}</td>
                        <td>${subcategory.categoryVo.categoryname}</td>
                        <td>${subcategory.subCategoryName}</td>
                        <td>${subcategory.subCategoryDescription}</td>
                        <td><a href="deletesubCategory.do?subCategoryId=${subcategory.subCategoryId}">Delete</a></td>
                       <td><a href="editsubCategory.do?subCategoryId=${subcategory.subCategoryId}">Edit</a></td>
                        </tr>
                        </c:forEach>
                     </tbody>
                  </table>
