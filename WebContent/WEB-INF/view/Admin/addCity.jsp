          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <div class="demo-form-wrapper">
                <f:form  action="insertCity.do"  data-toggle="validator" method="post" modelAttribute="city" >
                
                <div class="form-group">
                  <label for="name-1" class="control-label">Country_Name</label>
                    <f:select path="countryvo.countryId" id="countryId" onchange="LoadState()">
                  ...
                  <label for="name-1" class="control-label">State_Name</label>
                    <f:select path="statevo.stateId" id="StateId">
