              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <c:forEach items="${sessionScope.List}" var="state">
                      <tr>
                        <td>${state.stateId}</td>
                        <td>${state.countryvo.countryName}</td>
                        <td>${state.stateName}</td>
                        <td><a href="deletestate.do?stateId=${state.stateId}">Delete</a></td>
                       <td><a href="editstate.do?stateId=${state.stateId}">Edit</a></td>
                        </tr>
                        </c:forEach>
                     </tbody>
