          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <div class="demo-form-wrapper">
                <f:form data-toggle="validator" action="insertCoverSpecification.do" method="post" modelAttribute="CoverSpecification">
                  
                  <div class="form-group">
                    <label for="name-1" class="control-label">CoverSpecification_Name</label>
                    <f:input id="name-1" class="form-control" path="coverSpecificationName" />
                    </div>
                  
                  <div class="form-group">
                    <label for="biography-1" class="control-label">Cover_Description</label>
                    <f:textarea id="biography-1" class="form-control" path="coverDescription"></f:textarea>
                    </div>
