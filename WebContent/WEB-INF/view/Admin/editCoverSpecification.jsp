          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <div class="demo-form-wrapper">
                <f:form data-toggle="validator" action="updateCoverSpecification.do" method="get" modelAttribute="CoverSpecification">
                  <f:hidden path="coverSpecificationId"></f:hidden>
                  ...
                  <div class="form-group">
                    ...
                    <f:textarea id="biography-1" class="form-control" path="CoverDescription"  rows="3" />
                    </div>
