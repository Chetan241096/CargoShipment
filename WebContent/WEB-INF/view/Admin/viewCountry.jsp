              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <c:forEach items="${sessionScope.List}" var="country">
                      <tr>
                        <td>${country.countryId}</td>
                        <td>${country.countryName}</td>
                        <td><a href="deleteCountry.do?countryId=${country.countryId}">Delete</a></td>
                        <td><a href="editCountry.do?countryId=${country.countryId}">Edit</a></td>
                        </tr>
                        </c:forEach>
                     </tbody>
                  </table>
