              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <c:forEach items="${sessionScope.List}" var="city">
                      <tr>
                        <td>${city.cityId}</td>
                        <td>${city.countryvo.countryName}</td>
                        <td>${city.statevo.stateName}</td>
                        <td>${city.cityName}</td>
                        <td><a href="deleteCity.do?cityId=${city.cityId}">Delete</a></td>
                        <td><a href="editCity.do?cityId=${city.cityId}">Edit</a></td>
                        </tr>
                        </c:forEach>
                     </tbody>
