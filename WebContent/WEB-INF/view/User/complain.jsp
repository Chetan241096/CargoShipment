...
<div class="page-title" style="background-image: url('userresources/images/bg01.jpg')">
  <div class="container">
    <h1 class="entry-title">Complain</h1>
    <ol class="breadcrumb">
      <li><a href="#">Home</a></li>
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="custom-heading part-heading three-slashes">
          <h2>FILL COMPLAIN FORM</h2>
        </div>

        <div class="contact-form">

          <f:form action="insertcomplain.do" method="post" novalidate="novalidate" modelAttribute="complain">
            <div class="row">
              <div class="col-lg-6">
                <f:input class="form-control" type="text" path="complainTitle"  size="40" aria-required="true" aria-invalid="false" placeholder="Title" />
              </div>
              <div class="col-xs-12">
                <f:textarea class="form-control"  path="complainDescription" cols="40" rows="4" aria-invalid="false" placeholder="Description"/>
              </div>
              <div class="col-xs-12">
