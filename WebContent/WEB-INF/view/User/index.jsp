...
<div id="rev_slider_2_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="slider-01" style="margin:0px auto;background-color:#E9E9E9;padding:0px;margin-top:0px;margin-bottom:0px;">
  ...
  <div id="rev_slider_2_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.2.4.1">
    <ul>	<!-- SLIDE  -->
      <li data-index="rs-2" data-transition="random" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/s1_bg-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
        <!-- MAIN IMAGE -->
        <img src="userresources/images/s1_bg.jpg"  alt="" title="s1_bg"  width="1920" height="680" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        <!-- LAYERS -->
        ...
        <div class="tp-caption   tp-resizeme  icon"
             ...
             style="z-index: 5;text-transform:left;"><img src="userresources/images/s1_ob1.png" alt="" width="70" height="46" data-ww="" data-hh="" data-no-retina> </div>
      ...
      <!-- SLIDE  -->
      <li data-index="rs-3" data-transition="random" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/s2_bg-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
        <!-- MAIN IMAGE -->
        <img src="userresources/images/s2_bg.jpg"  alt="" title="Home 01"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        <!-- LAYERS -->
        ...
        <div class="tp-caption   tp-resizeme"
             ...
             style="z-index: 5;text-transform:left;"><img src="userresources/images/s2_ob1.png" alt="" width="296" height="68" data-ww="" data-hh="" data-no-retina> </div>
      ...
      <!-- SLIDE  -->
      <li data-index="rs-6" data-transition="random" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/image_900x600_01-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
        <!-- MAIN IMAGE -->
        <img src="userresources/images/image_900x600_01.jpg"  alt="" title="image_900x600_01"  width="1920" height="680" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        <!-- LAYERS -->
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="service-item">
          <img class="img-fluid" src="userresources/images/featured-services-01.jpg" alt="Transport">
          <div class="content">
      ...
      <div class="col-lg-4">
        <div class="service-item">
          <img class="img-fluid" src="userresources/images/featured-services-02.jpg" alt="Transport">
          <div class="content">
      ...
      <div class="col-lg-4">
        <div class="service-item">
          <img class="img-fluid" src="userresources/images/featured-services-03.jpg" alt="Transport">
          <div class="content">
...
<!-- REQUEST
================================================== -->
<section class="request parallax-window" data-parallax="scroll" data-image-src="images/request_bg.jpg">
  <div class="container">
    <div class="row">
    ...
    <div class="col-lg-6">
      ...
      <div class="latest-news">
        <div class="item">
          <div class="thumb">
            <a href="#">
              <img width="120" height="90" src="userresources/images/service_01.jpg" class="attachment-small-thumb wp-post-image" alt="image_900x600_06">
            </a>
          </div>
        ...
        <div class="item">
          <div class="thumb">
            <a href="#">
              <img width="120" height="90" src="userresources/images/service_02.jpg" class="attachment-small-thumb wp-post-image" alt="image_900x600_07">
            </a>
          </div>
        ...
        <div class="item">
          <div class="thumb">
            <a href="#">
              <img width="120" height="90" src="userresources/images/service_03.jpg" class="attachment-small-thumb wp-post-image" alt="image_900x600_05">
            </a>
          </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-01.png" title="CLIENT 01" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-02.png" title="CLIENT 02" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-03.png" title="CLIENT 03" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-04.png" title="CLIENT 04" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-05.png" title="CLIENT 05" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-06.png" title="CLIENT 06" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-07.png" title="CLIENT 07" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-08.png" title="CLIENT 08" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-09.png" title="CLIENT 09" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-10.png" title="CLIENT 10" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-11.png" title="CLIENT 11" class="thumbnail img-fluid">
        </a>
      </div>
      <div class="col-lg-2 col-sm-4 col-xs-6">
        <a href="#">
          <img src="userresources/images/client-12.png" title="CLIENT 12" class="thumbnail img-fluid">
        </a>
      </div>
    </div>
  </div>
