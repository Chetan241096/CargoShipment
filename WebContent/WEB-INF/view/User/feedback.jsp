  ...
  <div class="container">
    <div class="row">
        ...
        <div class="contact-form">
          ...
          <f:form action="insertfeedback.do" method="post" novalidate="novalidate" modelAttribute="feedback">
            <div class="row">
              <div class="col-lg-6">
                <f:input class="form-control" type="text" path="feedbackTitle" size="40" aria-required="true" aria-invalid="false" placeholder="Title" />
              </div>
              <div class="col-xs-12">
                <f:textarea class="form-control"  path="feedbackDescription" cols="40" rows="4" aria-invalid="false" placeholder="Description"/>
              </div>
              <div class="col-xs-12">
